    ...
    <div>
      <div className="App" data-theme={darkMode ? "dark" : "light"}>
          <Navbar expand="lg" className="navbar" data-theme={darkMode ? "dark" : "light"}>
            ...
            <Navbar.Collapse id="basic-navbar-nav" className='navflex'>
                <Nav className="mr-auto">
                    <Nav.Link href="#about" className="link">About me</Nav.Link>
                    <Nav.Link href="#skills" className="link">Skills</Nav.Link>
                    <Nav.Link href="#projects" className="link">Experience</Nav.Link>
          ...
          <hr></hr>
          <div id="home" className="topb">
          <Home darkMode={darkMode}/>
          </div>
          <div id="about" className="topb">
          <About darkMode={darkMode}/>
          </div>
          <div id="skills" className="topb">
          <Skills darkMode={darkMode}/>
          </div>
          <div id="projects" className='topb'>
            <Project darkMode={darkMode}/>
          </div>
          <div id="experience" className="topb">
          <Experience darkMode={darkMode}/>
          </div>
          <div id="contact" className="topb">
